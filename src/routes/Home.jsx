...
export default function Home() {
  ...
  return (
    <Box sx={{
      ...
      <Container maxWidth='lg' sx={{ display: { md: 'flex', xs: 'block' }, alignItems: 'center', height: '100vh' }}>
        <Box width={{ md: '50%', xs: '100%' }}>
          <h1 style={{ marginTop: 0, fontSize: 40 }}> Welcome to ECONOX Laos</h1>
          <p style={{ fontSize: 18 }}>We provide services for Environmental Impact Assessment, Consultancy for Corporate Social Responsibi
        ...
        <Box width={{ md: '50%', xs: '100%' }} marginTop={'10vh'} paddingLeft={20}>
          <img src={ImaBackground} alt="" width={'90%'} />
        </Box>
      </Container>
    </Box>
  )
